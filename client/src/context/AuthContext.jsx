        ...
        try {
            ...
            if (!error.response) {
                msg = window.location.hostname === 'localhost' 
                    ? 'Network Error: Backend unreachable. Ensure server is running on port 5000.'
                    : 'Network Error: Backend unreachable. Please check your internet or contact support.';
